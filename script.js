...
// Trial booking form — client-side only demo (no backend wired up)
const trialForm = document.getElementById('trial-form');
const formNote = document.getElementById('form-note');
if (trialForm) {
  trialForm.addEventListener('submit', (e) => {
    e.preventDefault();
    const name = trialForm.querySelector('[name="name"]').value.trim();
    formNote.textContent = name
      ? `Thanks, ${name}. A coach will email you within one business day to schedule your free session.`
      : 'A coach will email you within one business day to schedule your free session.';
    trialForm.reset();
  });
}
...
(function () {
  ...
  const knowledgeBase = [
    ...
    },
    {
      ...
      chips: ['What programs do you offer?', 'How much does membership cost?', 'What are your hours?']
    }
  ];
  ...
  const fallback = {
    ...
    chips: ['What programs do you offer?', 'How much does membership cost?', 'What are your hours?', 'How do I book a free session?']
  };
    ...
    if (useLiveApi) {
      askLiveAssistant(trimmed)
        .then(reply => {
          ...
          setChips(['What programs do you offer?', 'How much does membership cost?', 'What are your hours?']);
        })
        .catch(() => {
  ...
  function openPanel() {
    ...
    if (!started) {
      ...
      setChips(['What programs do you offer?', 'How much does membership cost?', 'What are your hours?', 'How do I book a free session?']);
    }
    input.focus();
  }
  function closePanel() {
